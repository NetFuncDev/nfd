...
sgx_status_t flowCounter(sgx_enclave_id_t eid, unsigned char* packet)
{
	sgx_status_t status;
	ms_flowCounter_t ms;
	ms.ms_packet = packet;
...
sgx_status_t initCounterList(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t getStat(sgx_enclave_id_t eid)
{
	sgx_status_t status;
