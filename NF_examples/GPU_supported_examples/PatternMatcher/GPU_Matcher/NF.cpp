...
if (1){
  ...
  //  p_match( haystack, LENGTH, sub_num, 16, subs);
...
int main(int argc, char* argv[])
{
    ...
    haystack = (char*)calloc(LENGTH, sizeof(char));
    ...
    printf("    size = %s	time = %f        ave_time = %f	 p_num = %d	pps = %f     sum = %ld    drop = %ld    drop_rate = %f \n", argv[1],total, total / 10000,sub_num, _s / total, _s, _drop, (double)_drop/(double)_s);
